      ...
      if (!userCheck) {
        ...
        <div style="width: 50%; background-color: whitesmoke;padding: 10px 30px;">
            ...
            <div style="display: flex;justify-content: center;margin-top:30px">
                <button style="background-color: #EE4037;border: none;color: whitesmoke;padding: 10px 20px;font-size: 15px;"><a href="http://localhost:7070/verifyEmail?token=${tokenEmail}" >Verify Here...</a></button>
            </div>
